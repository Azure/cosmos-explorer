...
describe('CloudShellClient', () => {
  ...
  describe('getUserRegion', () => {
    ...
    it('should handle errors when ARM request fails', async () => {
      ...
      await expect(getUserRegion('sub-id', 'resource-group', 'account-name')).rejects.toThrow('Failed to get user region');
  ...
  describe('verifyCloudShellProviderRegistration', () => {
    ...
    it('should handle errors when verification fails', async () => {
      ...
      await expect(verifyCloudShellProviderRegistration('sub-id')).rejects.toThrow('Failed to verify provider registration');
  ...
  describe('connectTerminal', () => {
    ...
    it('should handle errors when terminal connection fails', async () => {
      ...
      await expect(connectTerminal(consoleUri, size)).rejects.toThrow('Failed to connect to terminal: 500 Internal Server Error');
  ...
  describe('authorizeSession', () => {
    it('should call fetch with correct parameters', async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        'https://shell.azure.com/console123/authorize',
        {
          method: 'POST',
          headers: {
            'Accept': 'application/json',
