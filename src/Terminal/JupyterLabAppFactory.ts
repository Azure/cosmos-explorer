...
export class JupyterLabAppFactory {
  ...
  public async createTerminalApp(serverSettings: ServerConnection.ISettings): Promise<ITerminalConnection | undefined> {
    ...
    // this.startCloudShellterminal(panel);
  ...
  // public async startCloudShellterminal(panel: Panel) 
  // {
  //   const intervalsToClearRef = useRef<NodeJS.Timer[]>([]);

  //   const xterminal = useMemo(() => new XTerminal({
  //       convertEol: true
  //   }), []);
  ...
  //   let authorizationToken = armToken;
